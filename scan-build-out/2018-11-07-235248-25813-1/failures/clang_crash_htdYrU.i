# 1 "build_spec_graph.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 349 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "build_spec_graph.c" 2
...
# 1 "/afs/cs.wisc.edu/s/clang-6.0.1/@sys/lib/clang/8.0.0/include/stddef.h" 1 3 4
# 62 "/afs/cs.wisc.edu/s/clang-6.0.1/@sys/lib/clang/8.0.0/include/stddef.h" 3 4
typedef long unsigned int size_t;
# 90 "/afs/cs.wisc.edu/s/clang-6.0.1/@sys/lib/clang/8.0.0/include/stddef.h" 3 4
typedef int wchar_t;
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 3 "build_spec_graph.c" 2
# 1 "./build_spec_graph.h" 1
...
# 1 "/afs/cs.wisc.edu/s/clang-6.0.1/@sys/lib/clang/8.0.0/include/stdarg.h" 1 3 4
# 30 "/afs/cs.wisc.edu/s/clang-6.0.1/@sys/lib/clang/8.0.0/include/stdarg.h" 3 4
typedef __builtin_va_list va_list;
# 48 "/afs/cs.wisc.edu/s/clang-6.0.1/@sys/lib/clang/8.0.0/include/stdarg.h" 3 4
...
# 6 "./build_spec_graph.h" 2
# 1 "./build_spec_repr.h" 1
...
int ContainsCycles(Spec_Graph * graph) {
 ...
 while (unmarked_node_exists) {
  Spec_Representation * next = ((void*)0);
  for (int i = 0; i < graph->dimension; i++) {
